...
// See notes about this constructor in Scene9.h.
Scene9::Scene9(SDL_Window* sdlWindow_, GameManager* game_){
	window = sdlWindow_;
    game = game_;
...
void Scene9::OnDestroy() {}

void Scene9::Update(const float deltaTime) {
...
void Scene9::HandleEvents(const SDL_Event& event)
{
...
void Scene9::RenderStartMenuBackground()
{
