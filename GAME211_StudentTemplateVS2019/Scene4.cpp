...
bool Scene4::OnCreate() {
	...
	treeImage3 = IMG_Load("Assets/organic/bush.png");
	...
	treeImage5 = IMG_Load("Assets/organic/bush.png");
	treeTexture5 = SDL_CreateTextureFromSurface(renderer, treeImage5);

	treeImage6 = IMG_Load("Assets/organic/bush.png");
	...
	treeImage1_2 = IMG_Load("Assets/organic/bush.png");
	...
	treeImage4_2 = IMG_Load("Assets/organic/bush.png");
	...
	treeImage6_2 = IMG_Load("Assets/organic/bush.png");
	treeTexture6_2 = SDL_CreateTextureFromSurface(renderer, treeImage6_2);

	treeImage7_2 = IMG_Load("Assets/organic/bush.png");
	treeTexture7_2 = SDL_CreateTextureFromSurface(renderer, treeImage7_2);

	//tree row 3
	treeImage0_3 = IMG_Load("Assets/organic/bush1.png");
	...
	treeImage2_3 = IMG_Load("Assets/organic/bush.png");
	...
	treeImage4_3 = IMG_Load("Assets/organic/bush.png");
	...
	treeImage6_3 = IMG_Load("Assets/organic/bush.png");
...
void Scene4::Render() {
	...
	Vec3 tree_screenCoords4 = projectionMatrix * Vec3(10.5f, 15.0f, 0.0f);
	...
	Vec3 tree_screenCoords7_2 = projectionMatrix * Vec3(20.0f, 11.2f, 0.0f);
	...
	dest = scale(pathTexture, path_screenCoords.x, path_screenCoords.y, 0.3f);
	...
	dest = scale(treeTexture5, tree_screenCoords5.x, tree_screenCoords5.y, 0.9f); //bush1
	SDL_RenderCopy(renderer, treeTexture5, nullptr, &dest);

	dest = scale(treeTexture6, tree_screenCoords6.x, tree_screenCoords6.y, 1.0f); //bush1
	...
	//tree row 2
	dest = scale(treeTexture0_2, tree_screenCoords0_2.x, tree_screenCoords0_2.y, 0.8f); //bush1
	...
	dest = scale(treeTexture5_2, tree_screenCoords5_2.x, tree_screenCoords5_2.y, 0.9f); //bush1
	SDL_RenderCopy(renderer, treeTexture5_2, nullptr, &dest);

	dest = scale(treeTexture6_2, tree_screenCoords6_2.x, tree_screenCoords6_2.y, 1.0f); //bush1
	SDL_RenderCopy(renderer, treeTexture6_2, nullptr, &dest);

	dest = scale(treeTexture7_2, tree_screenCoords7_2.x, tree_screenCoords7_2.y, 1.0f); //bush
	SDL_RenderCopy(renderer, treeTexture7_2, nullptr, &dest);

	//tree row 3
	dest = scale(treeTexture0_3, tree_screenCoords0_3.x, tree_screenCoords0_3.y, 0.8f); //bush1
	...
	dest = scale(treeTexture5_3, tree_screenCoords5_3.x, tree_screenCoords5_3.y, 0.9f); //bush1
	SDL_RenderCopy(renderer, treeTexture5_3, nullptr, &dest);

	dest = scale(treeTexture6_3, tree_screenCoords6_3.x, tree_screenCoords6_3.y, 1.0f); //bush1
